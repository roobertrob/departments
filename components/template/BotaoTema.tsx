...
export default function BotaoTema(props: BotaoTemaProps) {
    return (props.tema === 'dark' ? (
        <div onClick={props.alternarTema} className={`hidden sm:flex items-center cursor-pointer bg-gradient-to-r 
        ...
        <div onClick={props.alternarTema} className={`hidden sm:flex justify-end items-center cursor-pronter bg-gradient-to-r 
